...
1. Download the following files (you will have to right-click on the `Raw` button on the page that opens):
  - `alb_vot.csv` from [here](https://github.com/stefanocoretta/sqmf/blob/main/data-raw/tutorial-files/alb_vot.csv).
  - `04_lm_cat.Rmd` from [here](https://github.com/stefanocoretta/sqmf/blob/main/data-raw/tutorial-files/04_lm_cat.Rmd).
  
1. Download the pupillometry data `PDQ_WT_preprocessed.csv` from <https://osf.io/s5ut8/>.

3. Copy `04_lm_cat.Rmd` to the `code` folder in your **RStudio project**.

  1. **NOTE**: Don't confuse RStudio with an RStudio project!!! RStudio is the software, a project is a folder with an `.Rproj` file.

4. Copy `alb_vot.csv` and `PDQ_WT_preprocessed.csv` to the `data` folder in your RStudio project.

5. Open `04_lm_cat.Rmd`.
