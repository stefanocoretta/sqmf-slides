...
We fitted a linear model with a Gaussian family to vowel duration, with C2 duration and speech rate (as syllables per second), including an interaction between the two.
...
Equivalently, the effect of speech rate on vowel duration increases by 0.19 ms for each unit increase (i.e. +1 ms) of C2 duration.
